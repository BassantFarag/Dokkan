...
const Carts = () => {
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center px-6 pb-24 pt-32 text-center">
      ...
      <h1 className="mb-2 text-xl font-bold text-[#2a2421] dark:text-[#f3ece7]">Your cart is empty</h1>
      <p className="mb-6 text-sm text-[#7a6f68] dark:text-[#a0948c]">
        You haven't added anything to your cart yet. Browse our products and start shopping.
      </p>
      <NavLink
        to="/shop"
